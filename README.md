...
- **`/pr`** — opens the PR with a short body a stranger to the feature can follow:
  the Jira ticket, why, what changed, the result, and screenshots when it's
